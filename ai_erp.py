...
load_dotenv()
PRELOADED_FILE_PATH = os.path.join('AI ERP.pdf')
        ...
        <div class="prompt-form-wrapper">
            <div class="prompt-form-container">
                ...
                <form class="prompt-form" id="prompt-form">
                    <textarea id="prompt-input" placeholder="Talk to KRATTOS ERP ..." rows="1"></textarea>
...
<script>
    ...
    function addNewChat() {
        ...
        chatSessions.push({
            ...
            history: [{ type: 'text', sender: 'ai', content: 'Hello! How can I help you today?' }],
            file: null, fileName: ''
        });
